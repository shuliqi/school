      ...
      <div id="webtian">
        <div class="content">
          <form action="article.modify.handle.php" method="post" enctype="multipart/form-data" >
                <input name="textBookNo" type="hidden" value="<?php echo $data['textBookNo'];?>" />
                <input id ="author" name="textBookName" value="<?php echo $data['textBookName'];?>" />
                <input id ="tips" name="major" value="<?php echo $data['major'];?>" />
                <input id ="title" name="unitPrice"  value="<?php echo $data['unitPrice'];?>" />
                <input id ="author" name="quantitgOnHand"  value="<?php echo $data['quantitgOnHand'];?>" />
                <div class="sub">
